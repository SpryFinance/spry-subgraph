...
export function updatePoolDayData(poolId: string, event: ethereum.Event): PoolDayData {
  ...
  if (poolDayData === null) {
    ...
    // Spry dynamic-fee accumulators for the day window (min/max/last stay null)
    poolDayData.swapCount = ZERO_BI
    poolDayData.sumFeePips = ZERO_BI
    poolDayData.feeWeightedVolumeUSD = ZERO_BD
    poolDayData.avgFeePips = ZERO_BD
...
export function updatePoolHourData(poolId: string, event: ethereum.Event): PoolHourData {
  ...
  if (poolHourData === null) {
    ...
    // Spry dynamic-fee accumulators for the hour window (min/max/last stay null)
    poolHourData.swapCount = ZERO_BI
    poolHourData.sumFeePips = ZERO_BI
    poolHourData.feeWeightedVolumeUSD = ZERO_BD
    poolHourData.avgFeePips = ZERO_BD
